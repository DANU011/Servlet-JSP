...
/*public class MyOperatorContainer {
	...
	private ArrayList<MyOperator> container = new ArrayList<>(); //실제는 해시맵을 많이 사용
...
public class MyOperatorContainer {
	...
	/*public void releaseOldObject(int millisecond) {
	   ...
	   public void releaseOldObject(int millisecond) {
	        ...
	        Map<String, MyOperator> newContainer = new HashMap<>();
	        
	        int size = container.size();

	        for (String keys : container.keySet()) {
	            MyOperator mo = container.get(keys);

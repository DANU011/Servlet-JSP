...
//	}
	...
	public static void main(String[] args) throws Exception { // static이라서 만들지 않아도 되지만
		...
		JDBCClientH2 cli = new JDBCClientH2(); // 클라이언트이름 new 해서 인스턴스 만드는 이유? 위에서는 인스턴스 필요하므로 메서드 사용하려고

		Class.forName("org.h2.Driver");

		try (Connection con = DriverManager.getConnection("jdbc:h2:tcp://localhost/~/musthave", "sa", "");) {// 드라이브-겟
																														// 가져옴

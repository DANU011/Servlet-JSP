...
<meta charset="UTF-8">
<title>검색 API</title>
<script scr="http://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js">
</script>
<script>
$(function() {
...
function sunFuncJson(d) {
	...
	$.each(d.items, function(index,item){
		...
		str += "	<li>"+item.posrdate+"</li>";
		str += "	<li><a herf='" + item.link + "' target='_blank'>바로가기</a></li>";
		str += "</ul>";
	});
